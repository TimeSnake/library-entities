...
public class ExCustomPathfinderGoalIllagerIllusionerCastSpellBlindness extends
  ...
  static class PathfinderGoalIllagerIllusionerCastSpellBlindness extends
    ...
    public boolean a() {
      return super.a() && (this.entity.getNMS().G() != null
          ...
          && this.entity.getNMS().s.d_(this.entity.getNMS().db())
          .a((float) EnumDifficulty.c.ordinal())));
    }
