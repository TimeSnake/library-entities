...
import de.timesnake.basic.entities.entity.extension.ExEntitySkeletonAbstract;
...
@NmsReflection
public class ExStray extends CraftStray implements EntityExtension<ExEntitySkeletonAbstract> {
    ...
    public ExStray(EntitySkeletonStray entity) {
