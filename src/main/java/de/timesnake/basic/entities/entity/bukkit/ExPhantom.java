...
import de.timesnake.basic.entities.entity.extension.ExEntityFlying;
...
public class ExPhantom extends CraftPhantom implements EntityExtension<ExEntityFlying> {
    ...
    public ExPhantom(EntityPhantom entity) {
