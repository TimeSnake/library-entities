...
import de.timesnake.basic.entities.entity.extension.ExEntitySpider;
...
public class ExCaveSpider extends CraftCaveSpider implements EntityExtension<ExEntitySpider> {
    ...
    public ExCaveSpider(EntityCaveSpider entity) {
