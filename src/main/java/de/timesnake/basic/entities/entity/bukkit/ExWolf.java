...
public class ExWolf extends CraftWolf implements EntityExtension<ExEntityTameableAnimal> {
    ...
    public ExWolf(EntityWolf entity) {
    ...
    public void tame(ExEntityHuman entity) {
        getExtension().tame(entity);
    }

    public boolean isWillSit() {
        return getExtension().isWillSit();
    }

    public void setWillSit(boolean tag) {
        getExtension().setWillSit(tag);
    }
}
