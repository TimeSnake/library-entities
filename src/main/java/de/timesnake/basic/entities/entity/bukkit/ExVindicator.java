...
import de.timesnake.basic.entities.entity.extension.ExEntityIllagerAbstract;
...
public class ExVindicator extends CraftVindicator implements EntityExtension<ExEntityIllagerAbstract> {
    ...
    public ExVindicator(EntityVindicator entity) {
