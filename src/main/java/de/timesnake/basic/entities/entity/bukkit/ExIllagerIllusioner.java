...
import de.timesnake.basic.entities.entity.extension.ExEntityIllagerWizard;
...
public class ExIllagerIllusioner extends CraftIllusioner implements EntityExtension<ExEntityIllagerWizard> {
    ...
    public ExIllagerIllusioner(EntityIllagerIllusioner entity) {
