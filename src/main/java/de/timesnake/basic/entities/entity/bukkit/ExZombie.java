...
@NmsReflection
public class ExZombie extends CraftZombie implements EntityExtension<ExEntityMonster> {

    public ExEntityMonster getExtension(CraftZombie zombie) {
        return new ExEntityMonster(zombie);
    }
