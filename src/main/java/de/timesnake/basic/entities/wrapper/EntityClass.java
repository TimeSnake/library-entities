...
public class EntityClass<E extends Entity> {
    ...
    public static final EntityClass<EntityAreaEffectCloud> EntityAreaEffectCloud = new EntityClass<>(EntityAreaEffectCloud.class);
    ...
    public static final EntityClass<EntityDragonFireball> EntityDragonFireball = new EntityClass<>(EntityDragonFireball.class);
    public static final EntityClass<EntityDrowned> EntityDrowned = new EntityClass<>(EntityDrowned.class);
    public static final EntityClass<EntityGuardianElder> EntityGuardianElder = new EntityClass<>(EntityGuardianElder.class);
    public static final EntityClass<EntityEnderCrystal> EntityEnderCrystal = new EntityClass<>(EntityEnderCrystal.class);
    ...
    public static final EntityClass<EntityExperienceOrb> EntityExperienceOrb = new EntityClass<>(EntityExperienceOrb.class);
    public static final EntityClass<EntityEnderSignal> EntityEnderSignal = new EntityClass<>(EntityEnderSignal.class);
    public static final EntityClass<EntityFallingBlock> EntityFallingBlock = new EntityClass<>(EntityFallingBlock.class);
    ...
    public static final EntityClass<EntityIllagerIllusioner> EntityIllagerIllusioner = new EntityClass<>(EntityIllagerIllusioner.class);
    ...
    public static final EntityClass<EntityLargeFireball> EntityLargeFireball = new EntityClass<>(EntityLargeFireball.class);
    ...
    public static final EntityClass<EntityMinecartRideable> EntityMinecartRideable = new EntityClass<>(EntityMinecartRideable.class);
    public static final EntityClass<EntityMinecartChest> EntityMinecartChest = new EntityClass<>(EntityMinecartChest.class);
    public static final EntityClass<EntityMinecartCommandBlock> EntityMinecartCommandBlock = new EntityClass<>(EntityMinecartCommandBlock.class);
    public static final EntityClass<EntityMinecartFurnace> EntityMinecartFurnace = new EntityClass<>(EntityMinecartFurnace.class);
    public static final EntityClass<EntityMinecartHopper> EntityMinecartHopper = new EntityClass<>(EntityMinecartHopper.class);
    public static final EntityClass<EntityMinecartMobSpawner> EntityMinecartMobSpawner = new EntityClass<>(EntityMinecartMobSpawner.class);
    ...
    public static final EntityClass<EntityShulkerBullet> EntityShulkerBullet = new EntityClass<>(EntityShulkerBullet.class);
    ...
    public static final EntityClass<EntityHorseSkeleton> EntityHorseSkeleton = new EntityClass<>(EntityHorseSkeleton.class);
    public static final EntityClass<EntitySlime> EntitySlime = new EntityClass<>(EntitySlime.class);
    public static final EntityClass<EntitySmallFireball> EntitySmallFireball = new EntityClass<>(EntitySmallFireball.class);
    ...
    public static final EntityClass<EntitySpectralArrow> EntitySpectralArrow = new EntityClass<>(EntitySpectralArrow.class);
    ...
    public static final EntityClass<EntitySkeletonStray> EntitySkeletonStray = new EntityClass<>(EntitySkeletonStray.class);
    ...
    public static final EntityClass<EntityThrownExpBottle> EntityThrownExpBottle = new EntityClass<>(EntityThrownExpBottle.class);
    public static final EntityClass<EntityPotion> EntityPotion = new EntityClass<>(EntityPotion.class);
    public static final EntityClass<EntityThrownTrident> EntityThrownTrident = new EntityClass<>(EntityThrownTrident.class);
    public static final EntityClass<EntityLlamaTrader> EntityLlamaTrader = new EntityClass<>(EntityLlamaTrader.class);
    public static final EntityClass<EntityTropicalFish> EntityTropicalFish = new EntityClass<>(EntityTropicalFish.class);
    ...
    public static final EntityClass<EntityVillagerTrader> EntityVillagerTrader = new EntityClass<>(EntityVillagerTrader.class);
    ...
    public static final EntityClass<EntitySkeletonWither> EntitySkeletonWither = new EntityClass<>(EntitySkeletonWither.class);
    ...
    public static final EntityClass<EntityZombieVillager> EntityZombieVillager = new EntityClass<>(EntityZombieVillager.class);
    ...
    public static final EntityClass<EntityTameableAnimal> EntityTameableAnimal = new EntityClass<>(EntityTameableAnimal.class);
    ...
    public static final EntityClass<EntityHorseAbstract> EntityHorseAbstract = new EntityClass<>(EntityHorseAbstract.class);
    public static final EntityClass<EntityHorseChestedAbstract> EntityHorseChestedAbstract = new EntityClass<>(EntityHorseChestedAbstract.class);
    public static final EntityClass<EntityMinecartAbstract> EntityMinecartAbstract = new EntityClass<>(EntityMinecartAbstract.class);
    public static final EntityClass<EntityMinecartContainer> EntityMinecartContainer = new EntityClass<>(EntityMinecartContainer.class);
    public static final EntityClass<EntityIllagerAbstract> EntityIllagerAbstract = new EntityClass<>(EntityIllagerAbstract.class);
    public static final EntityClass<EntityMonsterPatrolling> EntityMonsterPatrolling = new EntityClass<>(EntityMonsterPatrolling.class);
    public static final EntityClass<EntityPiglinAbstract> EntityPiglinAbstract = new EntityClass<>(EntityPiglinAbstract.class);
    public static final EntityClass<EntityRaider> EntityRaider = new EntityClass<>(EntityRaider.class);
    public static final EntityClass<EntitySkeletonAbstract> EntitySkeletonAbstract = new EntityClass<>(EntitySkeletonAbstract.class);
    ...
    public static final EntityClass<EntityProjectileThrowable> EntityProjectileThrowable = new EntityClass<>(EntityProjectileThrowable.class);
    public static final EntityClass<IProjectile> IProjectile = new EntityClass<>(IProjectile.class);
    public static final EntityClass<EntityVillagerAbstract> EntityVillagerAbstract = new EntityClass<>(EntityVillagerAbstract.class);
