...
@NmsReflection
public class ExMinecartFurnace extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMinecartFurnace implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExMinecartFurnace(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityMinecartFurnace(EntityTypes.ac, ((CraftWorld) world).getHandle()));
    }
