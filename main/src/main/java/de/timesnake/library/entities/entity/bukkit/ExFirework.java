...
@NmsReflection
public class ExFirework extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftFirework implements ExtendedCraftEntity<ExIProjectile> {

    public ExFirework(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityFireworks(EntityTypes.F, ((CraftWorld) world).getHandle()));
    }
