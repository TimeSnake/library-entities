...
@NmsReflection
public class ExLlamaSpit extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftLlamaSpit implements ExtendedCraftEntity<ExIProjectile> {

    public ExLlamaSpit(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityLlamaSpit(EntityTypes.Z, ((CraftWorld) world).getHandle()));
    }
