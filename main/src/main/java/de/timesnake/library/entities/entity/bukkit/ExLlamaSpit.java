...
@NmsReflection
public class ExLlamaSpit extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftLlamaSpit implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExLlamaSpit(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityLlamaSpit(EntityTypes.W, ((CraftWorld) world).getHandle()));
    }
