...
@NmsReflection
public class ExGhast extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGhast implements EntityExtension<ExEntityFlying> {

    private final ExEntityFlying extension = new ExEntityFlying(this);

    public ExGhast(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGhast(EntityTypes.F,
