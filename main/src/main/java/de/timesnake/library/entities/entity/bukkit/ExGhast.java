...
@NmsReflection
public class ExGhast extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGhast implements ExtendedCraftEntity<ExEntityFlying> {

    public ExGhast(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGhast(EntityTypes.I,
