...
@NmsReflection
public class ExEnderSignal extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderSignal implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExEnderSignal(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEnderSignal(EntityTypes.B, ((CraftWorld) world).getHandle()));
    }
