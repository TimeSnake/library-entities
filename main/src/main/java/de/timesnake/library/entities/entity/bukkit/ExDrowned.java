...
@NmsReflection
public class ExDrowned extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftDrowned implements ExtendedCraftEntity<ExEntityMonster> {

    public ExDrowned(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityDrowned(EntityTypes.u,
