...
@NmsReflection
public class ExAreaEffectCloud extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftAreaEffectCloud implements ExtendedCraftEntity<ExEntity> {

    public ExAreaEffectCloud(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityAreaEffectCloud(EntityTypes.c, ((CraftWorld) world).getHandle()));
    }
