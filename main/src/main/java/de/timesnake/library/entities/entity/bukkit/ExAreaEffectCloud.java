...
@NmsReflection
public class ExAreaEffectCloud extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftAreaEffectCloud implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExAreaEffectCloud(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityAreaEffectCloud(EntityTypes.b, ((CraftWorld) world).getHandle()));
    }
