...
@NmsReflection
public class ExCustomPathfinderGoalFollowOwner extends ExCustomPathfinderGoal {

    public ExCustomPathfinderGoalFollowOwner(double speed, float distance, float cancelDistance,
                                             boolean teleportOnLeaves) {
    ...
    public static class PathfinderGoalFollowOwner extends PathfinderGoal {
        ...
        public boolean b() {
            return !this.navigation.m() && (!this.entity.isWillSit()
                    && this.entity.distanceSquared(this.owner) > (double) (this.cancelDistance * this.cancelDistance));
        }
