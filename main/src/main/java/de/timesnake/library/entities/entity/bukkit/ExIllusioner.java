...
@NmsReflection
public class ExIllusioner extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftIllusioner implements EntityExtension<ExEntityIllagerWizard> {

    private final ExEntityIllagerWizard extension = new ExEntityIllagerWizard(this);

    public ExIllusioner(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityIllagerIllusioner(EntityTypes.O,
    ...
    public ExEntityIllagerWizard getExtension() {
        return extension;
    }

    // delegation to ExEntityIllagerWizard

    public boolean eX() {
        return this.extension.eX();
    }
