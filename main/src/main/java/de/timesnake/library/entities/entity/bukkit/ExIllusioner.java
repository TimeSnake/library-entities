...
@NmsReflection
public class ExIllusioner extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftIllusioner implements ExtendedCraftEntity<ExEntityIllagerWizard> {

    public ExIllusioner(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityIllagerIllusioner(EntityTypes.R,
