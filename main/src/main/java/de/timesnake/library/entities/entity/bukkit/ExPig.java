...
import java.util.*;
@NmsReflection
public class ExPig extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPig implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExPig(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPig(EntityTypes.aq,
