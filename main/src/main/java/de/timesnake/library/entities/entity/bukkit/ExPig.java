...
@NmsReflection
public class ExPig extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPig implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExPig(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPig(EntityTypes.an,
