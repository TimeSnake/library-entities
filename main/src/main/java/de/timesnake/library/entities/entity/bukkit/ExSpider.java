...
import java.util.*;
@NmsReflection
public class ExSpider extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSpider implements ExtendedCraftEntity<ExEntitySpider> {

    public ExSpider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySpider(EntityTypes.aL,
