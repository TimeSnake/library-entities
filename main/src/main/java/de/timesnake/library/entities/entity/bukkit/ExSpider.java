...
@NmsReflection
public class ExSpider extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSpider implements EntityExtension<ExEntitySpider> {

    private final ExEntitySpider extension = new ExEntitySpider(this);

    public ExSpider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySpider(EntityTypes.aI,
