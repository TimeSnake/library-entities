...
import java.util.*;
@NmsReflection
public class ExShulkerBullet extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftShulkerBullet implements ExtendedCraftEntity<ExIProjectile> {

    public ExShulkerBullet(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityShulkerBullet(EntityTypes.aC, ((CraftWorld) world).getHandle()));
    }
