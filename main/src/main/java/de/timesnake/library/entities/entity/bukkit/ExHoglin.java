...
@NmsReflection
public class ExHoglin extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftHoglin implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExHoglin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.hoglin.EntityHoglin(EntityTypes.L,
