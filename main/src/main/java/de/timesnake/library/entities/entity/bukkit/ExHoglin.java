...
@NmsReflection
public class ExHoglin extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftHoglin implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExHoglin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.hoglin.EntityHoglin(EntityTypes.O,
