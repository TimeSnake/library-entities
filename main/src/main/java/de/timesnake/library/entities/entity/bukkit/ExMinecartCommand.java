...
@NmsReflection
public class ExMinecartCommand extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMinecartCommand implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExMinecartCommand(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityMinecartCommandBlock(EntityTypes.ab, ((CraftWorld) world).getHandle()));
    }
