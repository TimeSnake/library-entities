...
@NmsReflection
public class ExPainting extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPainting implements EntityExtension<ExEntityHanging> {

    private final ExEntityHanging extension = new ExEntityHanging(this);

    public ExPainting(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityPainting(EntityTypes.aj, ((CraftWorld) world).getHandle()));
    }
