...
@NmsReflection
public class ExPainting extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPainting implements ExtendedCraftEntity<ExEntityHanging> {

    public ExPainting(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityPainting(EntityTypes.am, ((CraftWorld) world).getHandle()));
    }
