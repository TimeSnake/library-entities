...
@NmsReflection
public class ExGlowSquid extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGlowSquid implements ExtendedCraftEntity<ExEntityWaterAnimal> {

    public ExGlowSquid(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.GlowSquid(EntityTypes.L,
