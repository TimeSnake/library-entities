...
@NmsReflection
public class ExGlowSquid extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGlowSquid implements EntityExtension<ExEntityWaterAnimal> {

    private final ExEntityWaterAnimal extension = new ExEntityWaterAnimal(this);

    public ExGlowSquid(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.GlowSquid(EntityTypes.I,
