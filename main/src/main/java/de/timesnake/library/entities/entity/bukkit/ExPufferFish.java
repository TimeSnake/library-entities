...
import java.util.*;
@NmsReflection
public class ExPufferFish extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPufferFish implements ExtendedCraftEntity<ExEntityFish> {

    public ExPufferFish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPufferFish(EntityTypes.aw,
