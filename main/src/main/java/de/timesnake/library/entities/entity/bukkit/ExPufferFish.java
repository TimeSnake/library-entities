...
@NmsReflection
public class ExPufferFish extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPufferFish implements EntityExtension<ExEntityFish> {

    private final ExEntityFish extension = new ExEntityFish(this);

    public ExPufferFish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPufferFish(EntityTypes.at,
    ...
    public ExEntityFish getExtension() {
        return extension;
    }

    // delegation to ExEntityFish
