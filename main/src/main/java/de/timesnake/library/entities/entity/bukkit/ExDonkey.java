...
@NmsReflection
public class ExDonkey extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftDonkey implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExDonkey(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseDonkey(EntityTypes.s,
