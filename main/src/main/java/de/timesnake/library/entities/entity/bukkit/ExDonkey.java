...
@NmsReflection
public class ExDonkey extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftDonkey implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExDonkey(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseDonkey(EntityTypes.q,
