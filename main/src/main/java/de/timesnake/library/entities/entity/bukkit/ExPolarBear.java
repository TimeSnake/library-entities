...
@NmsReflection
public class ExPolarBear extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPolarBear implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExPolarBear(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPolarBear(EntityTypes.ar,
