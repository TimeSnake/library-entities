...
import java.util.*;
@NmsReflection
public class ExPolarBear extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPolarBear implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExPolarBear(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPolarBear(EntityTypes.au,
