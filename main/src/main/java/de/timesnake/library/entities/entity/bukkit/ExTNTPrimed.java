...
@NmsReflection
public class ExTNTPrimed extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftTNTPrimed implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExTNTPrimed(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityTNTPrimed(EntityTypes.as, ((CraftWorld) world).getHandle()));
    }
