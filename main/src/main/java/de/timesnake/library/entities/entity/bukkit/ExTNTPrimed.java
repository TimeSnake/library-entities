...
import java.util.*;
@NmsReflection
public class ExTNTPrimed extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTNTPrimed implements ExtendedCraftEntity<ExEntity> {

    public ExTNTPrimed(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityTNTPrimed(EntityTypes.av, ((CraftWorld) world).getHandle()));
    }
