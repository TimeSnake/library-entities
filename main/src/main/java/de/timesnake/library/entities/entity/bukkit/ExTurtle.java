...
import java.util.*;
@NmsReflection
public class ExTurtle extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTurtle implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExTurtle(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityTurtle(EntityTypes.aX,
