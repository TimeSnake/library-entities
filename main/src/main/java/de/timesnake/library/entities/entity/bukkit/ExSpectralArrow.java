...
@NmsReflection
public class ExSpectralArrow extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSpectralArrow implements EntityExtension<ExEntityArrow> {

    private final ExEntityArrow extension = new ExEntityArrow(this);

    public ExSpectralArrow(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySpectralArrow(EntityTypes.aH, ((CraftWorld) world).getHandle()));
    }

    public ExEntityArrow getExtension() {
        return extension;
    }

    // delegation to ExEntityArrow
