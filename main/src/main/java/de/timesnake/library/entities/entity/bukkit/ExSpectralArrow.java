...
import java.util.*;
@NmsReflection
public class ExSpectralArrow extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSpectralArrow implements ExtendedCraftEntity<ExEntityArrow> {

    public ExSpectralArrow(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySpectralArrow(EntityTypes.aK, ((CraftWorld) world).getHandle()));
    }
