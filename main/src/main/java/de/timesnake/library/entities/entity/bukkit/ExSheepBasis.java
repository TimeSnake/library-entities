...
@NmsReflection
public abstract class ExSheepBasis extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSheep implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExSheepBasis(net.minecraft.world.entity.animal.EntitySheep entity) {
        super(((CraftServer) Bukkit.getServer()), entity);
    }

        public ExSheepBasis(CraftServer server, net.minecraft.world.entity.animal.EntitySheep entity) {
            super(server, entity);
        }
