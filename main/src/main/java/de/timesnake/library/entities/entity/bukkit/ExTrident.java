...
import java.util.*;
@NmsReflection
public class ExTrident extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTrident implements ExtendedCraftEntity<ExEntityArrow> {

    public ExTrident(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityThrownTrident(EntityTypes.aU, ((CraftWorld) world).getHandle()));
    }
