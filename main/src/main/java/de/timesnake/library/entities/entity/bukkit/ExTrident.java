...
@NmsReflection
public class ExTrident extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftTrident implements EntityExtension<ExEntityArrow> {

    private final ExEntityArrow extension = new ExEntityArrow(this);

    public ExTrident(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityThrownTrident(EntityTypes.aQ, ((CraftWorld) world).getHandle()));
    }
