...
@NmsReflection
public class ExSkeletonHorse extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSkeletonHorse implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExSkeletonHorse(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseSkeleton(EntityTypes.aC,
    ...
    // delegation to ExEntityAnimal

    public net.minecraft.world.entity.EntityAgeable getNMS() {
