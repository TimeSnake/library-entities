...
import java.util.*;
@NmsReflection
public class ExPigZombie extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPigZombie implements ExtendedCraftEntity<ExEntityMonster> {

    public ExPigZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPigZombie(EntityTypes.bm,
