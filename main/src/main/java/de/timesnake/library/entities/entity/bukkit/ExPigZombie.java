...
@NmsReflection
public class ExPigZombie extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPigZombie implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExPigZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPigZombie(EntityTypes.bh,
