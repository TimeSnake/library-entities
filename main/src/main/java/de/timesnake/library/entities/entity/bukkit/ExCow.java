...
@NmsReflection
public class ExCow extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftCow implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExCow(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityCow(EntityTypes.p,
