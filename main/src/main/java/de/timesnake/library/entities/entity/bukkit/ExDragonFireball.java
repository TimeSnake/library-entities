...
@NmsReflection
public class ExDragonFireball extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftDragonFireball implements ExtendedCraftEntity<ExIProjectile> {

    public ExDragonFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityDragonFireball(EntityTypes.t, ((CraftWorld) world).getHandle()));
    }
