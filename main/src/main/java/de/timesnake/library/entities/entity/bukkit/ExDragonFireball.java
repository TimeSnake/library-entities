...
@NmsReflection
public class ExDragonFireball extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftDragonFireball implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExDragonFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityDragonFireball(EntityTypes.r, ((CraftWorld) world).getHandle()));
    }
