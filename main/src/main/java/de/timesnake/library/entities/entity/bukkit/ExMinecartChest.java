...
@NmsReflection
public class ExMinecartChest extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMinecartChest implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExMinecartChest(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityMinecartChest(EntityTypes.aa, ((CraftWorld) world).getHandle()));
    }
