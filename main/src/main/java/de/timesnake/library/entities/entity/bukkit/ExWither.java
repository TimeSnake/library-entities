...
import java.util.*;
@NmsReflection
public class ExWither extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWither implements ExtendedCraftEntity<ExEntityMonster> {

    public ExWither(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.wither.EntityWither(EntityTypes.be,
