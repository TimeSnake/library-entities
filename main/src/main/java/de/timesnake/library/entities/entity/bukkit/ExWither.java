...
@NmsReflection
public class ExWither extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftWither implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExWither(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.wither.EntityWither(EntityTypes.aZ,
