...
import java.util.*;
@NmsReflection
public class ExSquid extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSquid implements ExtendedCraftEntity<ExEntityWaterAnimal> {

    public ExSquid(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySquid(EntityTypes.aM,
