...
@NmsReflection
public class ExSquid extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSquid implements EntityExtension<ExEntityWaterAnimal> {

    private final ExEntityWaterAnimal extension = new ExEntityWaterAnimal(this);

    public ExSquid(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySquid(EntityTypes.aJ,
