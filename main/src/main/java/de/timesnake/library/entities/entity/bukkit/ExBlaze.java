...
@NmsReflection
public class ExBlaze extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftBlaze implements ExtendedCraftEntity<ExEntityMonster> {

    public ExBlaze(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityBlaze(EntityTypes.i,
