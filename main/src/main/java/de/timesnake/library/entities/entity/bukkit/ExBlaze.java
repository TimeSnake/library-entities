...
@NmsReflection
public class ExBlaze extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftBlaze implements EntityExtension<ExEntityMonster> {
    ...
    public ExBlaze(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityBlaze(EntityTypes.h,
