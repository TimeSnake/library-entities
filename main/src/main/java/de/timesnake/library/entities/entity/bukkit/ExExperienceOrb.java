...
@NmsReflection
public class ExExperienceOrb extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftExperienceOrb implements ExtendedCraftEntity<ExEntity> {

    public ExExperienceOrb(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityExperienceOrb(EntityTypes.C, ((CraftWorld) world).getHandle()));
    }
