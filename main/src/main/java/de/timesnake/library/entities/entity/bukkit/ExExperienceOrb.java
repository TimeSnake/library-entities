...
@NmsReflection
public class ExExperienceOrb extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftExperienceOrb implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExExperienceOrb(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityExperienceOrb(EntityTypes.A, ((CraftWorld) world).getHandle()));
    }
