...
@NmsReflection
public class ExEnderPearl extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEnderPearl implements ExtendedCraftEntity<ExIProjectile> {

    public ExEnderPearl(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEnderPearl(EntityTypes.aR, ((CraftWorld) world).getHandle()));
    }
