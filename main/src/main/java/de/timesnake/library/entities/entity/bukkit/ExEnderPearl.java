...
@NmsReflection
public class ExEnderPearl extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderPearl implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExEnderPearl(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEnderPearl(EntityTypes.aN, ((CraftWorld) world).getHandle()));
    }
