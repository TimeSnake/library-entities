...
import java.util.*;
@NmsReflection
public class ExSnowball extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSnowball implements ExtendedCraftEntity<ExIProjectile> {

    public ExSnowball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySnowball(EntityTypes.aJ, ((CraftWorld) world).getHandle()));
    }
