...
@NmsReflection
public class ExSnowball extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSnowball implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExSnowball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySnowball(EntityTypes.aG, ((CraftWorld) world).getHandle()));
    }
