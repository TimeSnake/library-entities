...
@NmsReflection
public class ExCaveSpider extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftCaveSpider implements EntityExtension<ExEntitySpider> {

    private final ExEntitySpider extension = new ExEntitySpider(this);

    public ExCaveSpider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityCaveSpider(EntityTypes.k,
    ...
    public ExEntitySpider getExtension() {
        return extension;
    }

    // delegation to ExEntitySpider
