...
@NmsReflection
public class ExCaveSpider extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftCaveSpider implements ExtendedCraftEntity<ExEntitySpider> {

    public ExCaveSpider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityCaveSpider(EntityTypes.m,
