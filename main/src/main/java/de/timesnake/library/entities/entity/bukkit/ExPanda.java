...
@NmsReflection
public class ExPanda extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPanda implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExPanda(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPanda(EntityTypes.an,
