...
@NmsReflection
public class ExPanda extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPanda implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExPanda(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityPanda(EntityTypes.ak,
