...
import java.util.*;
@NmsReflection
public class ExSmallFireball extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSmallFireball implements ExtendedCraftEntity<ExIProjectile> {

    public ExSmallFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySmallFireball(EntityTypes.aH, ((CraftWorld) world).getHandle()));
    }
