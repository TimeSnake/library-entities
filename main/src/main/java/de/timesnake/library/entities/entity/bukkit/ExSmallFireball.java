...
@NmsReflection
public class ExSmallFireball extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSmallFireball implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExSmallFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntitySmallFireball(EntityTypes.aE, ((CraftWorld) world).getHandle()));
    }
