...
import java.util.*;
@NmsReflection
public class ExTippedArrow extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTippedArrow implements ExtendedCraftEntity<ExEntityArrow> {

    public ExTippedArrow(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityTippedArrow(EntityTypes.e, ((CraftWorld) world).getHandle()));
    }
