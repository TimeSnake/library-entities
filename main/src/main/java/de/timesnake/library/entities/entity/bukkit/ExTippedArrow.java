...
@NmsReflection
public class ExTippedArrow extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftTippedArrow implements EntityExtension<ExEntityArrow> {

    private final ExEntityArrow extension = new ExEntityArrow(this);

    public ExTippedArrow(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityTippedArrow(EntityTypes.d, ((CraftWorld) world).getHandle()));
    }
