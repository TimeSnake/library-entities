...
@NmsReflection
public class ExLightningStrike extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftLightningStrike implements ExtendedCraftEntity<ExEntity> {

    public ExLightningStrike(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityLightning(EntityTypes.X, ((CraftWorld) world).getHandle()));
    }
