...
@NmsReflection
public class ExLightningStrike extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftLightningStrike implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExLightningStrike(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.EntityLightning(EntityTypes.U, ((CraftWorld) world).getHandle()));
    }
