...
@NmsReflection
public class ExSnowman extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSnowman implements EntityExtension<ExEntityGolem> {

    private final ExEntityGolem extension = new ExEntityGolem(this);

    public ExSnowman(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySnowman(EntityTypes.aF,
