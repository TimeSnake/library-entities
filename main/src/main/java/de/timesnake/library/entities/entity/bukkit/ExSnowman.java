...
import java.util.*;
@NmsReflection
public class ExSnowman extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSnowman implements ExtendedCraftEntity<ExEntityGolem> {

    public ExSnowman(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySnowman(EntityTypes.aI,
