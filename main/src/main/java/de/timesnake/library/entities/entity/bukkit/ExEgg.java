...
@NmsReflection
public class ExEgg extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEgg implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExEgg(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEgg(EntityTypes.aM, ((CraftWorld) world).getHandle()));
    }
