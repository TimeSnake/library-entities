...
@NmsReflection
public class ExEgg extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEgg implements ExtendedCraftEntity<ExIProjectile> {

    public ExEgg(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEgg(EntityTypes.aQ, ((CraftWorld) world).getHandle()));
    }
