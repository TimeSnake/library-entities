...
import java.util.*;
@NmsReflection
public class ExRabbit extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftRabbit implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExRabbit(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityRabbit(EntityTypes.ax,
