...
@NmsReflection
public class ExRabbit extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftRabbit implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExRabbit(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityRabbit(EntityTypes.au,
