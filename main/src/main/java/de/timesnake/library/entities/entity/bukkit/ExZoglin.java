...
import java.util.*;
@NmsReflection
public class ExZoglin extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftZoglin implements ExtendedCraftEntity<ExEntityMonster> {

    public ExZoglin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZoglin(EntityTypes.bi,
