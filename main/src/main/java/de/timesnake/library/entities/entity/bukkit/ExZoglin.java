...
@NmsReflection
public class ExZoglin extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftZoglin implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExZoglin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZoglin(EntityTypes.bd,
