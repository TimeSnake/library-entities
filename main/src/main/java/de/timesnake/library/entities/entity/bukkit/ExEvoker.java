...
@NmsReflection
public class ExEvoker extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEvoker implements EntityExtension<ExEntityIllagerWizard> {

    private final ExEntityIllagerWizard extension = new ExEntityIllagerWizard(this);

    public ExEvoker(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEvoker(EntityTypes.y,
