...
@NmsReflection
public class ExEvoker extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEvoker implements ExtendedCraftEntity<ExEntityIllagerWizard> {

    public ExEvoker(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEvoker(EntityTypes.A,
