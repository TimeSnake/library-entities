...
@NmsReflection
public class ExCat extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftCat implements EntityExtension<ExEntityTameableAnimal> {

    private final ExEntityTameableAnimal extension = new ExEntityTameableAnimal(this);

    public ExCat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityCat(EntityTypes.j,
