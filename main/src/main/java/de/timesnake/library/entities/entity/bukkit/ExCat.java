...
@NmsReflection
public class ExCat extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftCat implements ExtendedCraftEntity<ExEntityTameableAnimal> {

    public ExCat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityCat(EntityTypes.l,
