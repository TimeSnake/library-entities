...
import java.util.*;
@NmsReflection
public class ExVindicator extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftVindicator implements ExtendedCraftEntity<ExEntityIllagerAbstract> {

    public ExVindicator(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityVindicator(EntityTypes.ba,
