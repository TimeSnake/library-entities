...
@NmsReflection
public class ExVindicator extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftVindicator implements EntityExtension<ExEntityIllagerAbstract> {

    private final ExEntityIllagerAbstract extension = new ExEntityIllagerAbstract(this);

    public ExVindicator(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityVindicator(EntityTypes.aW,
    ...
    public ExEntityIllagerAbstract getExtension() {
        return extension;
    }

    // delegation to ExEntityIllagerAbstract
