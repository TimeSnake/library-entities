...
@NmsReflection
public class ExAxolotl extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftAxolotl implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExAxolotl(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.axolotl.Axolotl(EntityTypes.f,
