...
@NmsReflection
public abstract class ExCreeperBasis extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftCreeper implements EntityExtension<ExEntityCreeper> {

    private final ExEntityCreeper extension = new ExEntityCreeper(this);

    public ExCreeperBasis(net.minecraft.world.entity.monster.EntityCreeper entity) {
        super(((CraftServer) Bukkit.getServer()), entity);
    }

        public ExCreeperBasis(CraftServer server, net.minecraft.world.entity.monster.EntityCreeper entity) {
            super(server, entity);
        }

    public ExEntityCreeper getExtension() {
        return extension;
    }

    // delegation to ExEntityCreeper

    public void a(int arg0) {
         this.extension.a(arg0);
    }
    ...
    public net.minecraft.world.entity.monster.EntityMonster getNMS() {
        return this.extension.getNMS();
    }

    public int eK() {
        return this.extension.eK();
    }
