...
@NmsReflection
public abstract class ExHumanEntityBasis extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftHumanEntity implements EntityExtension<ExEntityHuman> {

    private final ExEntityHuman extension = new ExEntityHuman(this);

    public ExHumanEntityBasis(net.minecraft.world.entity.player.EntityHuman entity) {
        super(((CraftServer) Bukkit.getServer()), entity);
    }

        public ExHumanEntityBasis(CraftServer server, net.minecraft.world.entity.player.EntityHuman entity) {
            super(server, entity);
        }
    ...
    public com.mojang.authlib.GameProfile getProfile() {
        return this.extension.getProfile();
    }

    public java.util.UUID getUniqueID() {
        return this.extension.getUniqueID();
    }
