...
@NmsReflection
public class ExCreeper extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftCreeper implements ExtendedCraftEntity<ExEntityCreeper> {

    public ExCreeper(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityCreeper(EntityTypes.q,
