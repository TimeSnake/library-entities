...
@NmsReflection
public class ExWolf extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftWolf implements EntityExtension<ExEntityTameableAnimal> {
    ...
    public ExWolf(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityWolf(EntityTypes.bc,
