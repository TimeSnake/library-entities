...
import java.util.*;
@NmsReflection
public class ExWolf extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWolf implements ExtendedCraftEntity<ExEntityTameableAnimal> {

    public ExWolf(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityWolf(EntityTypes.bh,
