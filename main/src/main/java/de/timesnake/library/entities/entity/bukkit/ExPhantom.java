...
@NmsReflection
public class ExPhantom extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPhantom implements EntityExtension<ExEntityFlying> {

    private final ExEntityFlying extension = new ExEntityFlying(this);

    public ExPhantom(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPhantom(EntityTypes.am,
    ...
    public ExEntityFlying getExtension() {
        return extension;
    }

    // delegation to ExEntityFlying
