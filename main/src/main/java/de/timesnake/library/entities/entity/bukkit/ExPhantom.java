...
import java.util.*;
@NmsReflection
public class ExPhantom extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPhantom implements ExtendedCraftEntity<ExEntityFlying> {

    public ExPhantom(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPhantom(EntityTypes.ap,
