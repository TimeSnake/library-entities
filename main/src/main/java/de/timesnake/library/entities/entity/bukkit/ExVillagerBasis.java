...
@NmsReflection
public abstract class ExVillagerBasis extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftVillager implements EntityExtension<ExEntityVillagerAbstract> {

    private final ExEntityVillagerAbstract extension = new ExEntityVillagerAbstract(this);

    public ExVillagerBasis(net.minecraft.world.entity.npc.EntityVillager entity) {
        super(((CraftServer) Bukkit.getServer()), entity);
    }

        public ExVillagerBasis(CraftServer server, net.minecraft.world.entity.npc.EntityVillager entity) {
            super(server, entity);
        }
