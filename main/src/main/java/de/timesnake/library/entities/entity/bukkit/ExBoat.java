...
@NmsReflection
public class ExBoat extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftBoat implements ExtendedCraftEntity<ExEntity> {

    public ExBoat(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityBoat(EntityTypes.j, ((CraftWorld) world).getHandle()));
    }
