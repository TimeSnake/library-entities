...
@NmsReflection
public class ExBoat extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftBoat implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExBoat(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityBoat(EntityTypes.i, ((CraftWorld) world).getHandle()));
    }
