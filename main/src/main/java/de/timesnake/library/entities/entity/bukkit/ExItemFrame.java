...
@NmsReflection
public class ExItemFrame extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftItemFrame implements EntityExtension<ExEntityHanging> {

    private final ExEntityHanging extension = new ExEntityHanging(this);

    public ExItemFrame(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityItemFrame(EntityTypes.R, ((CraftWorld) world).getHandle()));
    }
