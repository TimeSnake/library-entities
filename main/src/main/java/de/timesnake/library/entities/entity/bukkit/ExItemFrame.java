...
@NmsReflection
public class ExItemFrame extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftItemFrame implements ExtendedCraftEntity<ExEntityHanging> {

    public ExItemFrame(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityItemFrame(EntityTypes.U, ((CraftWorld) world).getHandle()));
    }
