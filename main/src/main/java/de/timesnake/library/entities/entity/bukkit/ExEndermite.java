...
@NmsReflection
public class ExEndermite extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEndermite implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExEndermite(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEndermite(EntityTypes.x,
