...
@NmsReflection
public class ExEndermite extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEndermite implements ExtendedCraftEntity<ExEntityMonster> {

    public ExEndermite(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEndermite(EntityTypes.z,
