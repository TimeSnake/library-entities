...
@NmsReflection
public class ExLlama extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftLlama implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExLlama(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityLlama(EntityTypes.Y,
