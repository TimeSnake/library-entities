...
@NmsReflection
public class ExLlama extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftLlama implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExLlama(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityLlama(EntityTypes.V,
