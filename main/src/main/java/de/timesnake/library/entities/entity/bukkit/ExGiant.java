...
@NmsReflection
public class ExGiant extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGiant implements ExtendedCraftEntity<ExEntityMonster> {

    public ExGiant(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGiantZombie(EntityTypes.J,
