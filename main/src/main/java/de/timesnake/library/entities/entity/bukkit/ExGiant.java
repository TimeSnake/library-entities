...
@NmsReflection
public class ExGiant extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGiant implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExGiant(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGiantZombie(EntityTypes.G,
