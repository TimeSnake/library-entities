...
import java.util.*;
@NmsReflection
public class ExWitherSkull extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWitherSkull implements ExtendedCraftEntity<ExIProjectile> {

    public ExWitherSkull(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityWitherSkull(EntityTypes.bg, ((CraftWorld) world).getHandle()));
    }
