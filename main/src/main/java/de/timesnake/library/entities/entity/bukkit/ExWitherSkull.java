...
@NmsReflection
public class ExWitherSkull extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftWitherSkull implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExWitherSkull(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityWitherSkull(EntityTypes.bb, ((CraftWorld) world).getHandle()));
    }
