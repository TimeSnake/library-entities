...
@NmsReflection
public class ExEnderDragon extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderDragon implements EntityExtension<ExEntityInsentient> {

    private final ExEntityInsentient extension = new ExEntityInsentient(this);

    public ExEnderDragon(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.enderdragon.EntityEnderDragon(EntityTypes.v,
    ...
    public ExEntityInsentient getExtension() {
        return extension;
    }

    // delegation to ExEntityInsentient
