...
@NmsReflection
public class ExEnderDragon extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEnderDragon implements ExtendedCraftEntity<ExEntityInsentient> {

    public ExEnderDragon(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.enderdragon.EntityEnderDragon(EntityTypes.x,
