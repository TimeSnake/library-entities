...
import java.util.*;
@NmsReflection
public class ExThrownPotion extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftThrownPotion implements ExtendedCraftEntity<ExIProjectile> {

    public ExThrownPotion(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityPotion(EntityTypes.aT, ((CraftWorld) world).getHandle()));
    }
