...
@NmsReflection
public class ExThrownPotion extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftThrownPotion implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExThrownPotion(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityPotion(EntityTypes.aP, ((CraftWorld) world).getHandle()));
    }
