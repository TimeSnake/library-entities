...
@NmsReflection
public class ExWanderingTrader extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftWanderingTrader implements EntityExtension<ExEntityVillagerAbstract> {

    private final ExEntityVillagerAbstract extension = new ExEntityVillagerAbstract(this);

    public ExWanderingTrader(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.npc.EntityVillagerTrader(EntityTypes.aX,
    ...
    public ExEntityVillagerAbstract getExtension() {
        return extension;
    }

    // delegation to ExEntityVillagerAbstract

    public net.minecraft.world.entity.EntityLiving getNMS() {
