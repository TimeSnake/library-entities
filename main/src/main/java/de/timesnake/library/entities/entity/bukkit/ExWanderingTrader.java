...
import java.util.*;
@NmsReflection
public class ExWanderingTrader extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWanderingTrader implements ExtendedCraftEntity<ExEntityVillagerAbstract> {
