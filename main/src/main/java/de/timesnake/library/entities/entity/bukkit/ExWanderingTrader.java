...
@NmsReflection
public class ExWanderingTrader extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWanderingTrader implements EntityExtension<ExEntityVillagerAbstract> {

    public ExWanderingTrader(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.npc.EntityVillagerTrader(EntityTypes.bb,
