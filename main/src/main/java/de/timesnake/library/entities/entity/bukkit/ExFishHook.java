...
@NmsReflection
public class ExFishHook extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftFishHook implements ExtendedCraftEntity<ExIProjectile> {

    public ExFishHook(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityFishingHook(EntityTypes.bo, ((CraftWorld) world).getHandle()));
    }
