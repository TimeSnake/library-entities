...
@NmsReflection
public class ExFishHook extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftFishHook implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExFishHook(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityFishingHook(EntityTypes.bj, ((CraftWorld) world).getHandle()));
    }
