...
import java.util.*;
@NmsReflection
public class ExThrownExpBottle extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftThrownExpBottle implements ExtendedCraftEntity<ExIProjectile> {

    public ExThrownExpBottle(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityThrownExpBottle(EntityTypes.aS, ((CraftWorld) world).getHandle()));
    }
