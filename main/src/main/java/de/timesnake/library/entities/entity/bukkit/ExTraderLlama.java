...
import java.util.*;
@NmsReflection
public class ExTraderLlama extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTraderLlama implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExTraderLlama(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityLlamaTrader(EntityTypes.aV,
