...
@NmsReflection
public class ExTraderLlama extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftTraderLlama implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExTraderLlama(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityLlamaTrader(EntityTypes.aR,
