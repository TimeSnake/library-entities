...
import java.util.*;
@NmsReflection
public class ExPiglin extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPiglin implements ExtendedCraftEntity<ExEntityMonster> {

    public ExPiglin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.piglin.EntityPiglin(EntityTypes.ar,
