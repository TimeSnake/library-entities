...
import java.util.*;
@NmsReflection
public class ExZombie extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftZombie implements ExtendedCraftEntity<ExEntityMonster> {

    public ExZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombie(EntityTypes.bj,
