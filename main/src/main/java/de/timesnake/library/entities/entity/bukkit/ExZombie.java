...
@NmsReflection
public class ExZombie extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftZombie implements EntityExtension<ExEntityMonster> {
    ...
    public ExZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombie(EntityTypes.be,
