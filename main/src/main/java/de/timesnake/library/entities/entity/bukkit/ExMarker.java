...
@NmsReflection
public class ExMarker extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftMarker implements ExtendedCraftEntity<ExEntity> {

    public ExMarker(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.Marker(EntityTypes.ab, ((CraftWorld) world).getHandle()));
    }
