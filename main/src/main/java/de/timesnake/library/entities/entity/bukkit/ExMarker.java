...
@NmsReflection
public class ExMarker extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMarker implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExMarker(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.Marker(EntityTypes.Y, ((CraftWorld) world).getHandle()));
    }
