...
@NmsReflection
public class ExMinecartRideable extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftMinecartRideable implements ExtendedCraftEntity<ExEntity> {

    public ExMinecartRideable(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityMinecartRideable(EntityTypes.ac, ((CraftWorld) world).getHandle()));
    }
