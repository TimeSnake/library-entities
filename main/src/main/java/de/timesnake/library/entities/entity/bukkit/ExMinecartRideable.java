...
@NmsReflection
public class ExMinecartRideable extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMinecartRideable implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExMinecartRideable(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.vehicle.EntityMinecartRideable(EntityTypes.Z, ((CraftWorld) world).getHandle()));
    }
