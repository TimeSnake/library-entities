...
@NmsReflection
public class ExLeash extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftLeash implements ExtendedCraftEntity<ExEntityHanging> {

    public ExLeash(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityLeash(EntityTypes.W, ((CraftWorld) world).getHandle()));
    }
