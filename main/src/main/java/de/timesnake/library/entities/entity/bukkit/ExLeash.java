...
@NmsReflection
public class ExLeash extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftLeash implements EntityExtension<ExEntityHanging> {

    private final ExEntityHanging extension = new ExEntityHanging(this);

    public ExLeash(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityLeash(EntityTypes.T, ((CraftWorld) world).getHandle()));
    }
