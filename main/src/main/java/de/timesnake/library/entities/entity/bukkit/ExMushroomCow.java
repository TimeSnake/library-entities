...
@NmsReflection
public class ExMushroomCow extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMushroomCow implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExMushroomCow(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityMushroomCow(EntityTypes.ah,
