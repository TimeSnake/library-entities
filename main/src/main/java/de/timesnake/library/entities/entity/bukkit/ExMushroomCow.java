...
@NmsReflection
public class ExMushroomCow extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftMushroomCow implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExMushroomCow(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityMushroomCow(EntityTypes.ak,
