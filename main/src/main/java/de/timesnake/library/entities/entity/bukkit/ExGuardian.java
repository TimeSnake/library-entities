...
@NmsReflection
public class ExGuardian extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGuardian implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExGuardian(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGuardian(EntityTypes.K,
