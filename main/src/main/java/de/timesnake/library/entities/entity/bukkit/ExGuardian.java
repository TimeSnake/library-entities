...
@NmsReflection
public class ExGuardian extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGuardian implements ExtendedCraftEntity<ExEntityMonster> {

    public ExGuardian(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGuardian(EntityTypes.N,
