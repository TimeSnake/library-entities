...
@NmsReflection
public class ExMagmaCube extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMagmaCube implements EntityExtension<ExEntityInsentient> {

    private final ExEntityInsentient extension = new ExEntityInsentient(this);

    public ExMagmaCube(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityMagmaCube(EntityTypes.X,
