...
@NmsReflection
public class ExMagmaCube extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftMagmaCube implements ExtendedCraftEntity<ExEntityInsentient> {

    public ExMagmaCube(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityMagmaCube(EntityTypes.aa,
