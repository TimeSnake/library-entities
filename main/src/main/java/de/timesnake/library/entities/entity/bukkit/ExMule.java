...
@NmsReflection
public class ExMule extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftMule implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExMule(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseMule(EntityTypes.ag,
