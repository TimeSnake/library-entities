...
@NmsReflection
public class ExMule extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftMule implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExMule(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseMule(EntityTypes.aj,
