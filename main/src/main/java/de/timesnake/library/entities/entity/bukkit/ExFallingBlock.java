...
@NmsReflection
public class ExFallingBlock extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftFallingBlock implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExFallingBlock(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityFallingBlock(EntityTypes.C, ((CraftWorld) world).getHandle()));
    }
