...
@NmsReflection
public class ExFallingBlock extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftFallingBlock implements ExtendedCraftEntity<ExEntity> {

    public ExFallingBlock(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityFallingBlock(EntityTypes.E, ((CraftWorld) world).getHandle()));
    }
