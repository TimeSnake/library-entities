...
@NmsReflection
public class ExArmorStand extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftArmorStand implements ExtendedCraftEntity<ExEntityLiving> {

    public ExArmorStand(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityArmorStand(EntityTypes.d, ((CraftWorld) world).getHandle()));
    }
