...
@NmsReflection
public class ExArmorStand extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftArmorStand implements EntityExtension<ExEntityLiving> {

    private final ExEntityLiving extension = new ExEntityLiving(this);

    public ExArmorStand(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.EntityArmorStand(EntityTypes.c, ((CraftWorld) world).getHandle()));
    }

    public ExEntityLiving getExtension() {
        return extension;
    }

    // delegation to ExEntityLiving
