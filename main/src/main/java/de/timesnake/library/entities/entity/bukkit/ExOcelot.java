...
@NmsReflection
public class ExOcelot extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftOcelot implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExOcelot(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityOcelot(EntityTypes.al,
