...
@NmsReflection
public class ExOcelot extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftOcelot implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExOcelot(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityOcelot(EntityTypes.ai,
