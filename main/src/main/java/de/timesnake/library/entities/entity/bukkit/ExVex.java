...
import java.util.*;
@NmsReflection
public class ExVex extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftVex implements ExtendedCraftEntity<ExEntityMonster> {

    public ExVex(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityVex(EntityTypes.aY,
