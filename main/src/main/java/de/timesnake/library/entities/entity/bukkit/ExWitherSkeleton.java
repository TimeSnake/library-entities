...
import java.util.*;
@NmsReflection
public class ExWitherSkeleton extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWitherSkeleton implements ExtendedCraftEntity<ExEntitySkeletonAbstract> {

    public ExWitherSkeleton(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySkeletonWither(EntityTypes.bf,
