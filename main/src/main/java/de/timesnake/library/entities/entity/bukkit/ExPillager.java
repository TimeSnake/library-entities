...
import java.util.*;
@NmsReflection
public class ExPillager extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPillager implements ExtendedCraftEntity<ExEntityIllagerAbstract> {

    public ExPillager(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPillager(EntityTypes.at,
