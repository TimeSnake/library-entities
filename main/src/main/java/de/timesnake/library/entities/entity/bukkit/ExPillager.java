...
@NmsReflection
public class ExPillager extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftPillager implements EntityExtension<ExEntityIllagerAbstract> {
    ...
    public ExPillager(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityPillager(EntityTypes.aq,
