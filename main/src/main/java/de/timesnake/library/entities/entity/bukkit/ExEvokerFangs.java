...
@NmsReflection
public class ExEvokerFangs extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEvokerFangs implements ExtendedCraftEntity<ExEntity> {

    public ExEvokerFangs(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEvokerFangs(EntityTypes.B, ((CraftWorld) world).getHandle()));
    }
