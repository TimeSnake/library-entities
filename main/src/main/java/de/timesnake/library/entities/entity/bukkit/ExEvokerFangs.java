...
@NmsReflection
public class ExEvokerFangs extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEvokerFangs implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExEvokerFangs(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityEvokerFangs(EntityTypes.z, ((CraftWorld) world).getHandle()));
    }
