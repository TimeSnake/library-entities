...
@NmsReflection
public class ExGlowItemFrame extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGlowItemFrame implements EntityExtension<ExEntityHanging> {

    private final ExEntityHanging extension = new ExEntityHanging(this);

    public ExGlowItemFrame(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.GlowItemFrame(EntityTypes.H, ((CraftWorld) world).getHandle()));
    }
