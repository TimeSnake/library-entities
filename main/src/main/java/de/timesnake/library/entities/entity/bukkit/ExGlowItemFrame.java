...
@NmsReflection
public class ExGlowItemFrame extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGlowItemFrame implements ExtendedCraftEntity<ExEntityHanging> {

    public ExGlowItemFrame(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.decoration.GlowItemFrame(EntityTypes.K, ((CraftWorld) world).getHandle()));
    }
