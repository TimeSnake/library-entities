...
@NmsReflection
public class ExBee extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftBee implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExBee(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityBee(EntityTypes.g,
