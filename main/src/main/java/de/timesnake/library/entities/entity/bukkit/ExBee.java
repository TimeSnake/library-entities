...
@NmsReflection
public class ExBee extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftBee implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExBee(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityBee(EntityTypes.h,
