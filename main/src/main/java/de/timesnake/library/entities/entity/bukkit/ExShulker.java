...
@NmsReflection
public class ExShulker extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftShulker implements EntityExtension<ExEntityGolem> {

    private final ExEntityGolem extension = new ExEntityGolem(this);

    public ExShulker(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityShulker(EntityTypes.ay,
