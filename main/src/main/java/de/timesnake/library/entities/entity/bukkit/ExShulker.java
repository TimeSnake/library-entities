...
import java.util.*;
@NmsReflection
public class ExShulker extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftShulker implements ExtendedCraftEntity<ExEntityGolem> {

    public ExShulker(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityShulker(EntityTypes.aB,
