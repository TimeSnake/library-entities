...
@NmsReflection
public class ExChicken extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftChicken implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExChicken(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityChicken(EntityTypes.l,
