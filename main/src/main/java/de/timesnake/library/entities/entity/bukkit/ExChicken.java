...
@NmsReflection
public class ExChicken extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftChicken implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExChicken(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityChicken(EntityTypes.n,
