...
import java.util.*;
@NmsReflection
public class ExZombieHorse extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftZombieHorse implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExZombieHorse(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorseZombie(EntityTypes.bk,
