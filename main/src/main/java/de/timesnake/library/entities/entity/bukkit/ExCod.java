...
@NmsReflection
public class ExCod extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftCod implements EntityExtension<ExEntityFishSchool> {

    private final ExEntityFishSchool extension = new ExEntityFishSchool(this);

    public ExCod(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityCod(EntityTypes.m,
