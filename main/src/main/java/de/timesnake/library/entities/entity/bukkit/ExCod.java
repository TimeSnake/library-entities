...
@NmsReflection
public class ExCod extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftCod implements ExtendedCraftEntity<ExEntityFishSchool> {

    public ExCod(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityCod(EntityTypes.o,
