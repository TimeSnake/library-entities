...
import java.util.*;
@NmsReflection
public class ExPiglinBrute extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftPiglinBrute implements ExtendedCraftEntity<ExEntityMonster> {

    public ExPiglinBrute(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.piglin.EntityPiglinBrute(EntityTypes.as,
