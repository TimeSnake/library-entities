...
@NmsReflection
public class ExElderGuardian extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftElderGuardian implements ExtendedCraftEntity<ExEntityMonster> {

    public ExElderGuardian(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGuardianElder(EntityTypes.v,
