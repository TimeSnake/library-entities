...
@NmsReflection
public class ExElderGuardian extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftElderGuardian implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExElderGuardian(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityGuardianElder(EntityTypes.t,
