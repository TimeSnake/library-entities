...
@NmsReflection
public class ExRavager extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftRavager implements EntityExtension<ExEntityRaider> {

    private final ExEntityRaider extension = new ExEntityRaider(this);

    public ExRavager(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityRavager(EntityTypes.av,
    ...
    public ExEntityRaider getExtension() {
        return extension;
    }

    // delegation to ExEntityRaider
