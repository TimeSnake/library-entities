...
import java.util.*;
@NmsReflection
public class ExRavager extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftRavager implements ExtendedCraftEntity<ExEntityRaider> {

    public ExRavager(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityRavager(EntityTypes.ay,
