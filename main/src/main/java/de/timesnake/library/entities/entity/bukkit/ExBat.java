...
@NmsReflection
public class ExBat extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftBat implements ExtendedCraftEntity<ExEntityAmbient> {

    public ExBat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.ambient.EntityBat(EntityTypes.g,
