...
@NmsReflection
public class ExBat extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftBat implements EntityExtension<ExEntityAmbient> {

    private final ExEntityAmbient extension = new ExEntityAmbient(this);

    public ExBat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.ambient.EntityBat(EntityTypes.f,
    ...
    public ExEntityAmbient getExtension() {
        return extension;
    }

    // delegation to ExEntityAmbient
