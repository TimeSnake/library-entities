...
@NmsReflection
public class ExGoat extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftGoat implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExGoat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.goat.Goat(EntityTypes.M,
