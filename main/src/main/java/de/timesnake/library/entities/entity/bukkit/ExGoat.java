...
@NmsReflection
public class ExGoat extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftGoat implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExGoat(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.goat.Goat(EntityTypes.J,
