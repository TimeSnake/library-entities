...
@NmsReflection
public class ExIronGolem extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftIronGolem implements ExtendedCraftEntity<ExEntityGolem> {

    public ExIronGolem(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityIronGolem(EntityTypes.S,
