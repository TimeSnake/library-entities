...
@NmsReflection
public class ExIronGolem extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftIronGolem implements EntityExtension<ExEntityGolem> {

    private final ExEntityGolem extension = new ExEntityGolem(this);

    public ExIronGolem(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityIronGolem(EntityTypes.P,
