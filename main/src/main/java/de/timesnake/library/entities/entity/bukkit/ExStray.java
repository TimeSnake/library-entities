...
import java.util.*;
@NmsReflection
public class ExStray extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftStray implements ExtendedCraftEntity<ExEntitySkeletonAbstract> {

    public ExStray(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySkeletonStray(EntityTypes.aN,
