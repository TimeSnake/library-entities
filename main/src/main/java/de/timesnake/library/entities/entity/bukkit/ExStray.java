...
@NmsReflection
public class ExStray extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftStray implements EntityExtension<ExEntitySkeletonAbstract> {

    private final ExEntitySkeletonAbstract extension = new ExEntitySkeletonAbstract(this);

    public ExStray(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySkeletonStray(EntityTypes.aK,
