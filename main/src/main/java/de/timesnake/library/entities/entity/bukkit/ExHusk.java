...
@NmsReflection
public class ExHusk extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftHusk implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExHusk(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombieHusk(EntityTypes.N,
