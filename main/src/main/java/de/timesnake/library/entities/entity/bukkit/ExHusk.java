...
@NmsReflection
public class ExHusk extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftHusk implements ExtendedCraftEntity<ExEntityMonster> {

    public ExHusk(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombieHusk(EntityTypes.Q,
