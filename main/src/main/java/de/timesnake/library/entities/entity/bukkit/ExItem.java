...
@NmsReflection
public class ExItem extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftItem implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExItem(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityItem(EntityTypes.Q, ((CraftWorld) world).getHandle()));
    }
