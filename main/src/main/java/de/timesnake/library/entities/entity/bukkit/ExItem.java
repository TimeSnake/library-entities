...
@NmsReflection
public class ExItem extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftItem implements ExtendedCraftEntity<ExEntity> {

    public ExItem(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.item.EntityItem(EntityTypes.T, ((CraftWorld) world).getHandle()));
    }
