...
@NmsReflection
public class ExSilverfish extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSilverfish implements EntityExtension<ExEntityMonster> {
    ...
    public ExSilverfish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySilverfish(EntityTypes.aA,
