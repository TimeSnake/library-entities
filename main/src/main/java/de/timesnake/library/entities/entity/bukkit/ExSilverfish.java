...
import java.util.*;
@NmsReflection
public class ExSilverfish extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSilverfish implements ExtendedCraftEntity<ExEntityMonster> {

    public ExSilverfish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySilverfish(EntityTypes.aD,
