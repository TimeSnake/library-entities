...
@NmsReflection
public class ExVillagerZombie extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftVillagerZombie implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExVillagerZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombieVillager(EntityTypes.bg,
