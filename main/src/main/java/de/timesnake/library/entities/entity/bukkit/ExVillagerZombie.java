...
import java.util.*;
@NmsReflection
public class ExVillagerZombie extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftVillagerZombie implements ExtendedCraftEntity<ExEntityMonster> {

    public ExVillagerZombie(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityZombieVillager(EntityTypes.bl,
