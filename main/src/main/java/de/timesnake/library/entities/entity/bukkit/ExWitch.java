...
@NmsReflection
public class ExWitch extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftWitch implements EntityExtension<ExEntityRaider> {

    private final ExEntityRaider extension = new ExEntityRaider(this);

    public ExWitch(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityWitch(EntityTypes.aY,
