...
import java.util.*;
@NmsReflection
public class ExWitch extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftWitch implements ExtendedCraftEntity<ExEntityRaider> {

    public ExWitch(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityWitch(EntityTypes.bd,
