...
import java.util.*;
@NmsReflection
public class ExStrider extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftStrider implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExStrider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityStrider(EntityTypes.aO,
