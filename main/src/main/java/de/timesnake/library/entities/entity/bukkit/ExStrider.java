...
@NmsReflection
public class ExStrider extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftStrider implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExStrider(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityStrider(EntityTypes.aL,
