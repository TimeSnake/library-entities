...
@NmsReflection
public class ExEnderCrystal extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderCrystal implements EntityExtension<ExEntity> {

    private final ExEntity extension = new ExEntity(this);

    public ExEnderCrystal(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.enderdragon.EntityEnderCrystal(EntityTypes.u, ((CraftWorld) world).getHandle()));
    }
