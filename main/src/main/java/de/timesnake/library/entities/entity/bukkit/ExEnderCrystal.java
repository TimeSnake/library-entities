...
@NmsReflection
public class ExEnderCrystal extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEnderCrystal implements ExtendedCraftEntity<ExEntity> {

    public ExEnderCrystal(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.boss.enderdragon.EntityEnderCrystal(EntityTypes.w, ((CraftWorld) world).getHandle()));
    }
