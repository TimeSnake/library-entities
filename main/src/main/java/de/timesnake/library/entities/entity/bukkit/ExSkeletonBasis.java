...
@NmsReflection
public abstract class ExSkeletonBasis extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSkeleton implements EntityExtension<ExEntitySkeletonAbstract> {

    private final ExEntitySkeletonAbstract extension = new ExEntitySkeletonAbstract(this);

    public ExSkeletonBasis(net.minecraft.world.entity.monster.EntitySkeleton entity) {
        super(((CraftServer) Bukkit.getServer()), entity);
    }

        public ExSkeletonBasis(CraftServer server, net.minecraft.world.entity.monster.EntitySkeleton entity) {
            super(server, entity);
        }
