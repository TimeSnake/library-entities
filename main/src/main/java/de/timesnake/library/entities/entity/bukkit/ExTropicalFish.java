...
import de.timesnake.library.entities.entity.extension.ExEntityFishSchool;
...
@NmsReflection
public class ExTropicalFish extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftTropicalFish implements EntityExtension<ExEntityFishSchool> {

    private final ExEntityFishSchool extension = new ExEntityFishSchool(this);

    public ExTropicalFish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityTropicalFish(EntityTypes.aS,
    ...
    public ExEntityFishSchool getExtension() {
        return extension;
    }

    // delegation to ExEntityFishSchool
