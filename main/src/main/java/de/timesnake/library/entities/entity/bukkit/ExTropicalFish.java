...
import java.util.*;
@NmsReflection
public class ExTropicalFish extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftTropicalFish implements ExtendedCraftEntity<ExEntityFishSchool> {

    public ExTropicalFish(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityTropicalFish(EntityTypes.aW,
