...
@NmsReflection
public class ExLargeFireball extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftLargeFireball implements EntityExtension<ExIProjectile> {

    private final ExIProjectile extension = new ExIProjectile(this);

    public ExLargeFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityLargeFireball(EntityTypes.S, ((CraftWorld) world).getHandle()));
    }
