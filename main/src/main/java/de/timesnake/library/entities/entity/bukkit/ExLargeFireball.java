...
@NmsReflection
public class ExLargeFireball extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftLargeFireball implements ExtendedCraftEntity<ExIProjectile> {

    public ExLargeFireball(World world) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.projectile.EntityLargeFireball(EntityTypes.V, ((CraftWorld) world).getHandle()));
    }
