...
@NmsReflection
public class ExDolphin extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftDolphin implements EntityExtension<ExEntityWaterAnimal> {

    private final ExEntityWaterAnimal extension = new ExEntityWaterAnimal(this);

    public ExDolphin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityDolphin(EntityTypes.p,
    ...
    public ExEntityWaterAnimal getExtension() {
        return extension;
    }

    // delegation to ExEntityWaterAnimal
