...
@NmsReflection
public class ExDolphin extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftDolphin implements ExtendedCraftEntity<ExEntityWaterAnimal> {

    public ExDolphin(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityDolphin(EntityTypes.r,
