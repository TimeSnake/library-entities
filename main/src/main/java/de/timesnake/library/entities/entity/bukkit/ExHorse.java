...
@NmsReflection
public class ExHorse extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftHorse implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExHorse(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorse(EntityTypes.M,
