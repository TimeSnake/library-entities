...
@NmsReflection
public class ExHorse extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftHorse implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExHorse(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.horse.EntityHorse(EntityTypes.P,
