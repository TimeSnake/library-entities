...
@NmsReflection
public class ExFox extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftFox implements EntityExtension<ExEntityAnimal> {

    private final ExEntityAnimal extension = new ExEntityAnimal(this);

    public ExFox(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityFox(EntityTypes.E,
