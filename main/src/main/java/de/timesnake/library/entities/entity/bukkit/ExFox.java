...
@NmsReflection
public class ExFox extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftFox implements ExtendedCraftEntity<ExEntityAnimal> {

    public ExFox(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityFox(EntityTypes.G,
