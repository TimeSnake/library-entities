...
@NmsReflection
public class ExParrot extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftParrot implements EntityExtension<ExEntityTameableAnimal> {

    private final ExEntityTameableAnimal extension = new ExEntityTameableAnimal(this);

    public ExParrot(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityParrot(EntityTypes.al,
    ...
    public ExEntityTameableAnimal getExtension() {
        return extension;
    }

    // delegation to ExEntityTameableAnimal

    public net.minecraft.world.entity.animal.EntityAnimal getNMS() {
        return this.extension.getNMS();
    }

    public void tame(de.timesnake.library.entities.entity.extension.ExEntityHuman arg0) {
         this.extension.tame(arg0);
    }

    public boolean isWillSit() {
        return this.extension.isWillSit();
    }

    public void setWillSit(boolean arg0) {
         this.extension.setWillSit(arg0);
    }

    public void makeLove(net.minecraft.server.level.WorldServer arg0, de.timesnake.library.entities.entity.extension.ExEntityAnimal arg1) {
         this.extension.makeLove(arg0, arg1);
    }

    public void makeLove(net.minecraft.server.level.WorldServer arg0, net.minecraft.world.entity.animal.EntityAnimal arg1) {
         this.extension.makeLove(arg0, arg1);
    }

    public void setLoveTicks(int arg0) {
         this.extension.setLoveTicks(arg0);
    }

    public boolean isInLove() {
        return this.extension.isInLove();
    }

    public void resetLove() {
         this.extension.resetLove();
    }

    public boolean mate(de.timesnake.library.entities.entity.extension.ExEntityAnimal arg0) {
        return this.extension.mate(arg0);
    }

    public void setBaby(boolean arg0) {
         this.extension.setBaby(arg0);
    }

    public void createChild(de.timesnake.library.entities.entity.extension.ExEntityAgeable arg0) {
         this.extension.createChild(arg0);
    }
