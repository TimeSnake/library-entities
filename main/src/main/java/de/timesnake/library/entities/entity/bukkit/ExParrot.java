...
@NmsReflection
public class ExParrot extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftParrot implements ExtendedCraftEntity<ExEntityTameableAnimal> {

    public ExParrot(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntityParrot(EntityTypes.ao,
