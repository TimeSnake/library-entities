...
@NmsReflection
public class ExSlime extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSlime implements EntityExtension<ExEntityInsentient> {

    private final ExEntityInsentient extension = new ExEntityInsentient(this);

    public ExSlime(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySlime(EntityTypes.aD,
