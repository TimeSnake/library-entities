...
import java.util.*;
@NmsReflection
public class ExSlime extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSlime implements ExtendedCraftEntity<ExEntityInsentient> {

    public ExSlime(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntitySlime(EntityTypes.aG,
