...
@NmsReflection
public class ExEnderman extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftEnderman implements ExtendedCraftEntity<ExEntityMonster> {

    public ExEnderman(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEnderman(EntityTypes.y,
