...
@NmsReflection
public class ExEnderman extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftEnderman implements EntityExtension<ExEntityMonster> {

    private final ExEntityMonster extension = new ExEntityMonster(this);

    public ExEnderman(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.monster.EntityEnderman(EntityTypes.w,
