...
@NmsReflection
public class ExSalmon extends org.bukkit.craftbukkit.v1_18_R2.entity.CraftSalmon implements EntityExtension<ExEntityFishSchool> {

    private final ExEntityFishSchool extension = new ExEntityFishSchool(this);

    public ExSalmon(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySalmon(EntityTypes.aw,
