...
import java.util.*;
@NmsReflection
public class ExSalmon extends org.bukkit.craftbukkit.v1_19_R1.entity.CraftSalmon implements ExtendedCraftEntity<ExEntityFishSchool> {

    public ExSalmon(World world, boolean loadDefaultPathfinders) {
        super(((CraftServer) Bukkit.getServer()), new net.minecraft.world.entity.animal.EntitySalmon(EntityTypes.az,
